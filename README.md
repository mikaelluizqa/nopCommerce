Este README fornece instruções sobre como instalar e configurar o Cypress para testes de automação, além de descrever a estrutura do projeto e como rodar os testes.
